...
<form class="form-horizontal">
    ...
    <div class="row form-group">
            <label class="col-md-2">จำนวน :&nbsp;</label>
            <div class="col-md-3">
            ...
            <label class="col-md-2">น้ำหนัก :&nbsp;</label>
            <div class="col-md-3">
            	<input class="form-control" type="text">
            </div>
            <div class="col-md-1">
    ...
    <div class="row form-group">
    	...
    	<label class="col-md-2 text-right">ระหว่างเวลา :&nbsp;</label>
    	<div class="col-md-3">
    		<input type="text" class="form-control">
    	</div>
    </div>
    <div class="row form-group">
    	<label class="col-md-2 text-right">ถึง :&nbsp;</label>
    	<div class="col-md-3">
    		<input type="text" class="form-control">
    	</div>
    	<div class="col-md-1">
    ...
    <div class="row form-group">
    	...
    	<label class="col-md-1 text-right">แล้วนำขึ้นเรือ :&nbsp;</label>
    	<div class="col-md-3">
    		<input type="text" class="form-control">
      	</div>
    </div>
    <div class="row form-group">
    	<label class="col-md-2 text-right">ในวันที่ :&nbsp;</label>
    	<div class="col-md-3">
    		<div class="input-group">
    			<input type="text" class="form-control" placeholder="dd/mm/YY">
    			<div class="input-group-btn">
